...
try:
    ...
    data = pd.DataFrame(columns=[
        ...
        'passenger_count', 'total_amount', 'trip_minutes', 'trip_distance_km'
    ])

# --- Íconos ---
green_icon = {
    "iconUrl": "/assets/green_car.png",
    "iconSize": [25, 25]
}
red_icon = {
    "iconUrl": "/assets/red_car.png",
    "iconSize": [25, 25]
}
ICON_MAP = {
    ...
    for i, row in data.iterrows():
        ...
        pickup_markers.append(
            dl.Marker(
                ...
                icon=green_icon,
                children=[dl.Tooltip("Salida", className="fw-bold"), dl.Popup(popup_content)],
        ...
        dropoff_markers.append(
            dl.Marker(
                ...
                icon=red_icon,
                children=[dl.Tooltip("Llegada", className="fw-bold"), dl.Popup(popup_content)],
